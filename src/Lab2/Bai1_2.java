...
public class Bai1_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblStaffList.setShowGrid(true);
        jScrollPane1.setViewportView(tblStaffList);
        if (tblStaffList.getColumnModel().getColumnCount() > 0) {
            tblStaffList.getColumnModel().getColumn(0).setMaxWidth(40);
            tblStaffList.getColumnModel().getColumn(3).setMaxWidth(120);
            tblStaffList.getColumnModel().getColumn(4).setMaxWidth(130);
        }
